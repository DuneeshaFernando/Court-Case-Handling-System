...
public class Decree_preparation extends javax.swing.JPanel {
    ...
    private void jList1ValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_jList1ValueChanged
        ...
        jTextField4.setText("");
        try {
            ResultSet rs=dbcon.con().createStatement().executeQuery("SELECT j.* FROM judge j,decision c WHERE c.caseNumber='"+caseno+"' and c.result='Exparty' AND c.judgeNumber=j.judgeNumber");
            while(rs.next()){
