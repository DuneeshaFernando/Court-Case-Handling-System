...
import static courtcasehandlingsystem.MainInter_Shroff.casenumber;
 ...
 * @author Admin
 */
public class MainInter_courtclerk extends javax.swing.JFrame {
    static String uname;
    ...
    RollCourt r_court;
    MyProfile myprof;
    BenchProceedings bench_proc;
    /**
     * Creates new form MainInter
     */
    public MainInter_courtclerk() {
        ...
        try {
            ActivityLog.activity_log(MainInter_courtclerk.uname,"login","courtclerk");
        } catch (Exception ex) {
            Logger.getLogger(MainInter_courtclerk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jPanel5.setBackground(new java.awt.Color(220, 220, 255));
        ...
        jButton3.setText("Roll Court Proceedings");
        ...
        jButton7.setText("Bench Proceeedings");
        ...
        jPanel7.setBackground(new java.awt.Color(220, 220, 255));
        ...
        jCalendar5.setBackground(new java.awt.Color(220, 220, 255));
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(15, 15, 15)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jButton14, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(jCalendar5, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGap(140, 140, 140)
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        r_court=new RollCourt();
        jDesktopPane1.add(r_court);
        jDesktopPane1.repaint();
        jDesktopPane1.revalidate();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        bench_proc=new BenchProceedings();
        jDesktopPane1.add(bench_proc);
        jDesktopPane1.repaint();
        jDesktopPane1.revalidate();
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        try {
            ActivityLog.activity_log(MainInter_courtclerk.uname,"log out","courtclerk");
        } catch (Exception ex) {
            Logger.getLogger(MainInter_courtclerk.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainInter_courtclerk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainInter_courtclerk().setVisible(true);
            }
        });
    }
