 ...
 * @author Admin
 */
public class MainInter_Shroff extends javax.swing.JFrame {
    static String uname;
    ...
    public MainInter_Shroff() {
        ...
        try {
            ActivityLog.activity_log(MainInter_Shroff.uname,"login","Shroff");
        } catch (Exception ex) {
            Logger.getLogger(MainInter_Shroff.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Stamp Duty Process");
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        try {
            ActivityLog.activity_log(MainInter_Shroff.uname,"log out","Shroff");
        } catch (Exception ex) {
            Logger.getLogger(MainInter_Shroff.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainInter_Shroff.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MainInter_Shroff().setVisible(true);
            }
        });
    }
